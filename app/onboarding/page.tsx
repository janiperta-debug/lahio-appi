      ...
      <div className="w-full max-w-2xl">
        <Card className="bg-white border-slate-200 shadow-lg">
          <CardHeader className="text-center pb-4">
            ...
            <CardTitle className="text-2xl text-slate-800 font-sans">Kerro itsestäsi</CardTitle>
          ...
          <CardContent className="space-y-6">
            {currentStep === 1 && (
              <div className="space-y-6">
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <h3 className="text-lg font-semibold text-slate-800 font-sans">Perustiedot</h3>
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <Textarea
                    ...
                    className="border-slate-300 focus:border-cyan-800 focus:ring-cyan-800 min-h-[100px]"
                    value={formData.bio}
                    onChange={(e) => setFormData({ ...formData, bio: e.target.value })}
                  />
                  <p className="text-xs text-slate-500">Vapaaehtoinen - auttaa muita tutustumaan sinuun</p>
                </div>

                <div className="space-y-3">
                  <Label className="text-slate-700">Kiinnostuksen kohteet</Label>
                  <div className="grid grid-cols-2 gap-3">
                    {interestOptions.map((interest) => (
                      <div key={interest} className="flex items-center space-x-2">
                        ...
                        />
                        <Label htmlFor={interest} className="text-sm text-slate-600 cursor-pointer">
                          {interest}
                        </Label>
                      </div>
                    ))}
            ...
            {currentStep === 2 && (
              <div className="space-y-6">
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <h3 className="text-lg font-semibold text-slate-800 font-sans">Perhe ja lapset</h3>
                </div>
                ...
                <div className="space-y-4">
                  ...
                  {formData.hasChildren && (
                    <div className="space-y-2 ml-6">
                      <Label htmlFor="childrenAges" className="text-slate-700">
                        Lasten iät
                      </Label>
                      <Input
                        id="childrenAges"
                      ...
                      />
                      <p className="text-xs text-slate-500">Auttaa löytämään sopivan ikäisiä leikkikavereita</p>
                    </div>
                  )}
                </div>
              </div>
            ...
            {currentStep === 3 && (
              <div className="space-y-6">
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <h3 className="text-lg font-semibold text-slate-800 font-sans">Auttaminen ja tuki</h3>
                </div>

                <div className="space-y-6">
                  <div className="space-y-3">
                    <Label className="text-slate-700">Voin auttaa näissä</Label>
                    <div className="grid grid-cols-2 gap-3">
                      {helpOptions.map((help) => (
                        <div key={help} className="flex items-center space-x-2">
                          ...
                          />
                          <Label htmlFor={`can-${help}`} className="text-sm text-slate-600 cursor-pointer">
                            {help}
                          </Label>
                        </div>
                      ))}
                  ...
                  <div className="space-y-3">
                    <Label className="text-slate-700">Kaipaisin apua näissä</Label>
                    <div className="grid grid-cols-2 gap-3">
                      {helpOptions.map((help) => (
                        <div key={help} className="flex items-center space-x-2">
                          <Checkbox
                          ...
                          />
                          <Label htmlFor={`need-${help}`} className="text-sm text-slate-600 cursor-pointer">
                            {help}
                          </Label>
                        </div>
                      ))}
            ...
            <div className="flex justify-between pt-6 border-t border-slate-200">
              ...
              <Button onClick={nextStep} className="bg-cyan-800 hover:bg-cyan-900 text-white">
